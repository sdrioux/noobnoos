== n00bn00s[link:http://n00bn00s.herokuapp.com] (formerly known as readit)
...
2.  <no>Create categories for each link.  Users should be able to click a category and see all associated links.</no>
