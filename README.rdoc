...
I am currently a student at a 10 week Web Development bootcamp known as MakerSquare.
...
The app uses an API for *Webthumb*, a service that, when a user first creates a link, will crawl to that site, and provide the app with a picture
...
*WebSolr Sunspot 1.3* server on *Amazon EC2*.
